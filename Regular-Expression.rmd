 ...
 **^[^** B-D]                     |When used at the beginning of a character class in [], ^ indicates matching characters **NOT** in the indicated class
 ...
 **+**                            |+: at least one of the item
 ...
 Flood|fire|hurricane             |= or; we can include any number of alternatives
 ^[Gg]ood|[Bb]ad                  |find the string that begins with Good/good or contains Bad/bad
 ^([Gg]ood|[Bb]ad)                |() :constrain the alternatives, find the string that begins with Good/good or Bad/bad
